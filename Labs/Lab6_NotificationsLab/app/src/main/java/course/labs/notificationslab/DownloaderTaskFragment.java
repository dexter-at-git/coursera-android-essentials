...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> idArrayList = getArguments().getIntegerArrayList("friends");
        Integer[] ids = new Integer[idArrayList.size()];
        idArrayList.toArray(ids);
    ...
    public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
        ...
        protected String[] doInBackground(Integer... integers) {
            String[] tweets = downloadTweets(integers);
            return tweets;
        }
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultCode() != MainActivity.IS_ALIVE) {
                                ...
                                // successfully
                                mContentView.setTextViewText(R.id.text, "qwe");
